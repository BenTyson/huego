...
import { importPalette, formatLabels } from "@/lib/import";
import { ModalBase, ModalCancelButton, ModalPrimaryButton } from "./ui/ModalBase";
...
export function ImportModal({ isOpen, onClose, onShowToast }: ImportModalProps) {
  ...
  const footer = (
    <>
      {input && (
        <ModalCancelButton onClick={handleClear}>Clear</ModalCancelButton>
      )}
